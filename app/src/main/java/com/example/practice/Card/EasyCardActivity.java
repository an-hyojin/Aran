...
public class EasyCardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomDialog dialog = new CustomDialog(this, "감정 카드놀이", "같은 표정을 가진 카드를 짝지어보세요","시작",R.drawable.cards, false);
            ...
            if (second.isBack()) {
                ...
                if (first.value == second.value) {
                    ...
                    if (SUCCESS_COUNT == TOTAL_CARD_NUM/2) {
                        CustomDialog finalDialog = new CustomDialog(this,"게임종료","게임이 끝났습니다.","확인", R.drawable.cards, false);
                        DialogListenerInterface dialogListenerInterface = new DialogListenerInterface() {
                            @Override
                            public void onPositiveClicked() {
                                Intent outIntent = new Intent(EasyCardActivity.this, SelectActivity.class);
                        ...
                        finalDialog.setDialogListener(dialogListenerInterface);
                        finalDialog.show();
